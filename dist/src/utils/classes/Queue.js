...
export default class Queue {
    constructor(guild) {
         ...
         */
        this.get = async (page, pageSize = config.paginate_max_results) => {
         ...
         */
        this.move = async (initialIndex, newIndex) => {
            ...
            if (Number.isNaN(initialIndexAdjusted) || Number.isNaN(newIndexAdjusted))
                throw Error('Invalid index values. Integers only.');
