 ...
 */
export function getFileList(directory, fileType = '.js') {
    try {
        if (!directory)
            return [];
...
export function getPercentage(percentage) {
    ...
    if (volumeInt === NaN || volumeInt > 100 || volumeInt < 0)
        return false;
 ...
 */
export async function getPlaylist(url, maxResults = config.youtube_playlist_max_results) {
    try {
        const yt = youtube({
            version: 'v3',
